...
/**
 * Consignmentaddress entity. @author MyEclipse Persistence Tools
 */

public class Consignmentaddress implements java.io.Serializable {
	...
	/** minimal constructor */
	public Consignmentaddress(City cityByDistrict, Customer customer,
			City cityByCountry, City cityByCity, City cityByProvince,
			String consignmentname, String address, String postcode,
			Byte deleteflag) {
